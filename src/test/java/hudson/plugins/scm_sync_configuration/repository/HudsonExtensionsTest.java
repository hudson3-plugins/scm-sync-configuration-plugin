...
public abstract class HudsonExtensionsTest extends ScmSyncConfigurationPluginBaseTest {
	...
	public void shouldFileWhichHaveToBeInSCM() throws Throwable {
		assertStrategy(HudsonConfigScmSyncStrategy.class, Mockito.mock(Saveable.class), "config.xml");
		assertStrategy(HudsonConfigScmSyncStrategy.class, Mockito.mock(Saveable.class), "hudson.scm.SubversionSCM.xml");
